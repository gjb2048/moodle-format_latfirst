<?php
/**
   This file contains general functions for the course format Latest First
 ...
 */
function callback_latfirst_uses_sections() {
    return true;
}

/**
 * Used to display the course structure for a course where format=Latest First
 *
 ...
 */
function callback_latfirst_load_content(&$navigation, $course, $coursenode) {
	return $navigation->load_generic_course_sections($course, $coursenode, 'latestfirstcoll');
}
 ...
 * @return string
 */
function callback_latfirst_definition() {
    return get_string('sectionname','format_latfirst');
}
 ...
 * @return string
 */
function callback_latfirst_request_key() {
    return 'latfirst';
}
 ...
 * @return string
 */
function callback_latfirst_get_section_name($course, $section) {
    ...
    if (!empty($section->name)) {
        ...
        return get_string('section0name', 'format_latfirst');
    } else {
 ...
 * @return stdClass
 */
function callback_latfirst_ajax_support() {
